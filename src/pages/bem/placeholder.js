  ...
  <section class="product-right">
    ...
    <div class="freight">
      ...
      <div class="freight-wrapper-bottom">
        ...
        <a class="freight__donotknow" href="http/www.buscacep.correios.com.br/sistemas/buscacep/"
          >Não sei meu CEP</a
        >
      </div>
    </div>
...
<article class="details-prod container-center">
  <section class="details-prod__descriptions">
    <div class="details-prod__box-title">
      <h4
        class="details-prod__title details-prod__title--description"
        data-ref=".productDescription"
      >
        Descrição do produto
      </h4>
      <h4
        class="details-prod__title details-prod__title--use"
        data-ref=".value-field.Modo-de-Uso"
      >
        Modo de uso
      </h4>
      <h4
        class="details-prod__title details-prod__title--benefits"
        data-ref=".value-field.Beneficios-e-Indicacao"
      >
        Benefícios e indicação
      </h4>
      <h4
        class="details-prod__title details-prod__title--comnposition"
        data-ref=".value-field.Composicao"
      >
        Composição
      </h4>
    </div>
